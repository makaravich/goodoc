...
/**
 * The class allows to easily adding option page
...
class GOODOC_Custom_Options {
	...
	public function add_options_page(): void {
		add_submenu_page(
			$this->model['location'] ?? 'options-general.php',
	...
	private function fill_text( $args ): void {
        ...
        <input class="<?php echo $this->model['id'] ?>  cso-input" type="text"
               ...
               value="<?php echo esc_attr( $val ) ?>" <?php echo $attributes ?>/>
		<?php
	}

	/**
	 * Renders field with number input
	 *
	 * @param $args
	 */
	private function fill_number( $args ): void {
		$val        = $this->get_option( $args['long_id'] );
		$attributes = $args['attributes'] ?? '';
		?>
        <input class="<?php echo $this->model['id'] ?>  cso-input" type="number"
               name="<?php echo $this->model['id'] ?>[<?php echo $args['long_id'] ?>]"
               value="<?php echo esc_attr( $val ) ?>" <?php echo $attributes ?>/>
		<?php
	}
